...
public class MusicScoreMatching extends JFrame
	...
	public void search() {
		...
		if (index >= 0) {   // match found
			...
			message("You note is wrong! Press ESC to start a new search");
		}
	}
		...
		public static void main(String args[]) {
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					...
					new MusicScoreMatching().setVisible(true);
				}
			});
		}
